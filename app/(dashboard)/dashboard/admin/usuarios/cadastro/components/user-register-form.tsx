...
const formSchema = z.object({
  ...
  accountType: z.enum(["Administrador", "Usuário"], { message: "Tipo da conta inválido" }),
...
export const UserRegisterForm = () => {
  ...
  return (
    <div className="w-full bg-white p-6 rounded-2xl shadow-md">
      <h4 className="text-foreground text-lg font-semibold mb-5 lg:text-xl">Adicione o usuário</h4>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-full flex flex-col gap-9">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <Input className="input-reset" placeholder="Insira o nome do usuário" {...field} />
                    </div>
                  </FormControl>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <Input className="input-reset" placeholder="Insira o e-mail" {...field} />
                    </div>
                  </FormControl>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          <CalendarDaysIcon strokeWidth={1.5} className="size-5 text-primary" />
                          {field.value ? (
                            format(field.value, "PPP", { locale: ptBR })
                          ) : (
                            <span className="text-base text-muted-foreground font-normal">Selecione a data</span>
                          )}
                        </Button>
                      </FormControl>
                    </PopoverTrigger>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      <BuildingIcon size={20} strokeWidth={1.5} className="text-primary" />

                      <Input className="input-reset" placeholder="Insira o nome da empresa" {...field} />
                    </div>
                  </FormControl>
          ...
          <div className="w-full flex flex-col gap-5 sm:flex-row-reverse">
            ...
            <Button onClick={handleBack} type="button" size="lg" variant="outline" className="w-full sm:w-44">
